        ...
        <main class="app-main">
            <div class="main-content container-fluid p-4">
                ...
                <div class="category-header mb-4">
                    <div>
                        <h2 class="fw-bold mb-1">Edit Topic</h2>
                ...
                <div class="cat-label mb-4">
                    <span class="cat-label-text"><?= esc($topic['topic_name']) ?></span>
                    <span class="cat-count-pill">Editing</span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="info-card">
                            <div class="mb-4">
                                <h5 class="fw-bold mb-1">Topic Details</h5>
                            </div>

                            <form method="post" action="<?= base_url('admin/edit_topic/'.$topic['topic_id']) ?>">
                                <?= csrf_field() ?>

                                <div class="mb-4">
                                    <label class="form-label custom-label">Topic Name</label>
                                    <input type="text" name="topic_name" class="form-control custom-input" value="<?= esc($topic['topic_name']) ?>" required>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label custom-label">Description</label>
                                    <textarea name="description" class="form-control custom-input" rows="5"><?= esc($topic['description']) ?></textarea>
                                </div>

                                <div class="d-flex justify-content-end gap-2">
                                    <a href="<?= base_url('admin/topics/'.$topic['subject_id']) ?>" class="btn btn-light rounded-pill px-4">Cancel</a>
