        ...
        <main class="app-main">
            <div class="main-content container-fluid p-4">
                ...
                <div class="category-header mb-4">
                    <div>
                        <h2 class="fw-bold mb-1">Add Topic</h2>
                        <p class="text-muted mb-0">Create a new topic for this subject</p>
                    </div>
                    <a href="<?= base_url('admin/topics/'.$subject['subject_id']) ?>" class="btn btn-outline-secondary rounded-pill px-4">
                        <i class="fas fa-arrow-left me-2"></i> Back
                    </a>
                </div>

                <div class="course-header-line mb-4">
                    <h5 class="course-header-title mb-0"><?= esc($subject['subject_name']) ?></h5>
                    <span class="course-header-pill">Course</span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="info-card">
                            <div class="mb-4"><h5 class="fw-bold mb-1">Topic Details</h5></div>

                            <form method="post">
                                <div class="mb-4">
                                    <label class="form-label custom-label">Topic Name</label>
                                    <input type="text" name="topic_name" class="form-control custom-input" placeholder="Enter topic name" required>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label custom-label">Description</label>
                                    <textarea name="description" class="form-control custom-input" rows="5" placeholder="Brief description about this topic"></textarea>
                                </div>

                                <div class="d-flex justify-content-end gap-2">
                                    <a href="<?= base_url('admin/topics/'.$subject['subject_id']) ?>" class="btn btn-light rounded-pill px-4">Cancel</a>
