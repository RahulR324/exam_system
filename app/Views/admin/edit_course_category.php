                ...
                <div class="info-card">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted mb-0">
                            Modify the category details below and save your changes.
                        </p>

                    </div>

                    <form method="post"
                          action="<?= base_url('admin/edit_course_category/'.$category['category_id']) ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description"
                                      class="form-control custom-input"
                                      rows="5"><?= esc($category['description']) ?></textarea>
