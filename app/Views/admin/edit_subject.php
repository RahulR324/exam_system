        ...
        <main class="app-main">
            <div class="main-content container-fluid p-4">
                <div class="category-header mb-4">
                    <div>
                        <h2 class="fw-bold mb-1">Edit Subject</h2>
                        <p class="text-muted mb-0">Update subject information</p>
                    </div>
                    <a href="<?= base_url('admin/subjects/'.$subject['course_id']) ?>" class="btn btn-outline-secondary rounded-pill px-4">
                ...
                <div class="course-header-line mb-4">
                    ...
                    <span class="course-header-pill">Subject</span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="info-card">
                            <div class="mb-4"><h5 class="fw-bold mb-1">Subject Details</h5></div>
                            
                            <form method="post" action="<?= base_url('admin/edit_subject/'.$subject['subject_id']) ?>">
                                <div class="mb-4">
                                    <label class="form-label custom-label">Subject Name</label>
                                    <input type="text" name="subject_name" class="form-control custom-input" value="<?= esc($subject['subject_name']) ?>" required>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label custom-label">Description</label>
                                    <textarea name="description" class="form-control custom-input" rows="5"><?= esc($subject['description']) ?></textarea>
                                </div>

                                <div class="d-flex justify-content-end gap-2">
                                    <a href="<?= base_url('admin/subjects/'.$subject['course_id']) ?>" class="btn btn-light rounded-pill px-4">Cancel</a>
                                    <button type="submit" class="btn btn-outline-primary rounded-pill px-4">
                                        <i class="ti ti-device-floppy me-2"></i> Update Subject
                                    </button>
                                </div>
                            </form>
                        </div>
