...
<head>
    ...
    <title>Edit Question Bank - Admin</title>
...
<nav class="app-header navbar navbar-expand bg-body">
    ...
    <div class="main-content container-fluid p-4">
        ...
        <div class="category-header mb-4">
            ...
            <div>
                <h2 class="fw-bold mb-1">Edit Question Bank</h2>
                <p class="text-muted mb-0">
                    Update question bank information and hierarchy settings
                </p>
            </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8">
                ...
                <div class="info-card">
                    ...
                    <form method="post"
                          action="<?= base_url('admin/edit_question_bank/'.$questionBank['questionbank_id']) ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="parent_id"
                                ...
                                <?php foreach($questionBanks as $bank): ?>
                                    ...
                                    <?php if($bank['questionbank_id'] != $questionBank['questionbank_id']): ?>

                                        <option value="<?= $bank['questionbank_id'] ?>"
                                            <?= ($bank['questionbank_id'] == $questionBank['parent_id']) ? 'selected' : '' ?>>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control custom-input"
                                   value="<?= esc($questionBank['questionbank_name']) ?>"
                                   required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description"
                                      rows="5"
                                      class="form-control custom-input"
                                      placeholder="Enter description"><?= esc($questionBank['description']) ?></textarea>
